                ...
                <div className="services-card">
                    ...
                    <div>
                      <Link href={'/products/iqos'}>Смотреть
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m9 6l6 6l-6 6"/></svg>
                      </Link>
                    </div>
                </div>
                <Image src={'/Home/Hero/hero2.png'} alt="IQOS Iluma" width={1000} height={1000} />
              </SwiperSlide>
              <SwiperSlide>
                <div className="services-card">
